...
*/
x.ui.Element = x.base.Base.clone({
    id          : "Element",
    jquery_elem : null
});
...
x.ui.Element.define("attr", function (attr, value, valid_xml_content) {
...
x.ui.Element.define("makeElement", function (tag, css_class, id) {
    var elmt;
    this.append("<" + tag + "/>");
...
x.ui.Element.define("makeAnchor", function (label, href, css_class, id, hover_text, target) {
...
x.ui.Element.define("makeInput", function (type, id, value, css_class, placeholder) {
...
x.ui.Element.define("makeOption", function (id, label, selected, css_class) {
...
x.ui.Element.define("makeHidden", function (id, value, css_class) {
    var elmt = this.makeElement("input", css_class, id);
...
x.ui.Element.define("makeRadio", function (control, id, selected, css_class) {
...
x.ui.Element.define("makeRadioLabelSpan", function (control, id, label, selected) {
...
x.ui.Element.define("makeCheckbox", function (control, id, checked, css_class) {
    var elmt = this.makeElement("input", css_class, control + "." + id);
...
x.ui.Element.define("makeCheckboxLabelSpan", function (control, id, label, checked) {
    var span_elmt = this.makeElement("span", "css_attr_item", control);
...
x.ui.Element.define("makeUniIcon", function (icon, href, id) {
...
x.ui.Element.define("makeTooltip", function (label, text, css_class) {
...
x.ui.Element.define("makeLabel", function (label, for_id, css_class, tooltip) {
...
x.ui.Element.define("makeDropdownUL", function (control, right_align) {
...
x.ui.Element.define("makeDropdownButton", function (control, label, url, tooltip, css_class, right_align) {
...
x.ui.Element.define("makeDropdownIcon", function (control, label, url, tooltip, css_class, right_align) {
...
x.ui.Element.define("makeDropdownLabel", function (label, right_align) {
    if (right_align) {
